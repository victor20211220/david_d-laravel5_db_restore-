...
@section("page_title")
    Edit Message <small>Editing message.</small>
@endsection
...
@section('content')
    ...
    {{ Form::open(array('url' => 'messages/edit/submit/'.$message["id"].'')) }}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    @if($message["type"] == "call")
                        <div class="form-group">
                            ...
                            {{ Form::text('lead_name', $message["name"], array('class' => 'form-control', 'placeholder'=>'Full Name')) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('lead_email', 'Email Address') }}
                            {{ Form::text('lead_email', $message["email"], array('class' => 'form-control', 'placeholder'=>'Email Address')) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('lead_email_alt', 'Alternative Email Address') }}
                            {{ Form::text('lead_email_alt', $message["email_alt"], array('class' => 'form-control', 'placeholder'=>'Alternative Email')) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('lead_phone', 'Phone Number') }}
                            {{ Form::text('lead_phone', $message["phone"], array('class' => 'form-control', 'placeholder'=>'Phone Number')) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('lead_phone_alt', 'Alternative Phone Number') }}
                            {{ Form::text('lead_phone_alt', $message["phone_alt"], array('class' => 'form-control', 'placeholder'=>'Alternative Phone')) }}
                        </div>
                    @endif
                    <div class="form-group">
                        {{ Form::label('lead_message', 'Message') }}
                        <textarea name="lead_message" class="form-control lead_message" placeholder="Message" rows="10">{{$message["message"]}}</textarea>
                    </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        {{ Form::text('lead_area', $message["area"], array('class' => 'form-control area', 'placeholder'=>'Location', 'id' => 'autocomplete')) }}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="free_lead" {{ ($message["status"] == "free") ? 'checked' : '' }} />
                    </div>
    ...
    <script type="text/javascript">
        ...
        var selectedIndustry = "{{$message["industry"]}}";
