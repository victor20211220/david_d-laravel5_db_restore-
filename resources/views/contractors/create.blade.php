...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Form::open(array('url' => 'contractors')) }}
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" value="" class="contractor_area" name="contractor_area" />
                        <input type="hidden" value="" class="contractor_overall_area" name="contractor_overall_area" />
                        <input name="" id="tags" value="" class="form-control" style="width: 100%;" />
                        <hr/>
                        <div class="row">
                            <div class="col-xs-3">
                                <p>Province:</p>
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('contractor_leads', Input::old('contractor_leads'), array('class' => 'form-control', 'placeholder' => '123')) }}
                    </div>
                ...
                <div class="box-footer">
                    {{ Form::submit('Create Contractor', array('class' => 'btn btn-primary')) }}
                </div>
            </div>
            {{ Form::close() }}
        </div>
